...
using UnityEngine;
using Gradient = CTRFramework.Shared.Gradient;
...
namespace CTRFramework
{
    public class SceneHeader : IReadWrite
    {
        ...
        public List<UIntPtr> animatedTextureAddresses = new List<UIntPtr>();
        ...
        public void Read(BinaryReaderEx br)
        {
            ...
            br.Jump(ptrAnimTex.Address);
            Debug.Log("texture animation");
            for(int i = 0; i < 32; i++)
            {
                var address = br.ReadUIntPtr();
                animatedTextureAddresses.Add(address);
            }
