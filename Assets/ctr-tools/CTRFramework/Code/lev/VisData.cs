...
namespace CTRFramework
{
    public class VisData : IReadWrite
    {
        ...
        public List<QuadBlock> QuadPointers = new List<QuadBlock>();
        ...
        {
            BaseAddress = (int)br.BaseStream.Position;

            byteflag = br.ReadByte();
            flag = (VisDataFlags)byteflag;
            unk0 = br.ReadByte();
            ...
            if (br.BaseStream.Position - BaseAddress != SizeOf)
        ...
        public void Write(BinaryWriterEx bw, List<UIntPtr> patchTable = null)
        {
            ...
            if (bw.BaseStream.Position - pos != SizeOf)
                Helpers.Panic(this, PanicType.Error, "visdata sizeof mismatch");
        }
